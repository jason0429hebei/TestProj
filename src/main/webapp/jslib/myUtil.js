/**
 * easyui extension method
 * 
 */

var sy = $.extend({}, sy);/* namespase */

/**
 * 
 * cancel easyui default parser
 * 
 * open progress bar
 * 
 * after display all components，close progress bar
 * 
 */
$.parser.auto = false;
$(function() {
...
/**
 * loading message for panel/datagrid
 * 
 */
$.fn.panel.defaults.loadingMessage = 'In progress....';
$.fn.datagrid.defaults.loadMsg = 'In progress....';
 ...
 * 
 * used in datagrid/treegrid/tree/combogrid/combobox/form loading error
 */
...
/**
 * add menu for datagrid、treegrid
 * 
 */
var createGridHeaderContextMenu = function(e, field) {
	e.preventDefault();
	var grid = $(this);/* grid itself */
	var headerContextMenu = this.headerContextMenu;/* menu for grid */
...
/**
 * keep panel/window/dialog within browser
 * @param left
 * @param top
 */
var easyuiPanelOnMove = function(left, top) {
	...
	$(this).parent().css({/* correct position */
		left : l,
		top : t
	});
};
...
/**
 * extend validatebox，add feature of two password compation
 * 					   add feature of number check
 * 
 */
...
/**
 * extend datagrid，add/delete Editor
 * 
 * for example
 * 
...
/**
 * xtend editor of datagrid
 * 
 * add tree with multiple choice
 * 
 * add editor of timedate
 * 
 * add multiple combobox
 */
 ...
 * usage:sy.pn();
 * 
 * @returns project name(/zhibing_ssh)
 */
sy.pn = function() {
...
/**
 * add formatString feature
 * 
 * usage：sy.fs('String{0}String{1}String','First arg','Second arg');
 * 
 ...
 * namespace
 * 
 * usage：sy.ns('jQuery.bbb.ccc','jQuery.eee.fff');
 */
sy.ns = function() {
	var o = {}, d;
...
/**
 * return list based on a string split by ','
 * 
 * @returns list
 */
...
/**
 * change default attribute and method of AJAX in jQuery 
 */
$.ajaxSetup({
	type : 'POST',
